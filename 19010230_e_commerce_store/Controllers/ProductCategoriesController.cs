...
namespace _19010230_e_commerce_store.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,TotalOrders")] ProductCategory productCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CategoryName,TotalOrders")] ProductCategory productCategory)
        {
