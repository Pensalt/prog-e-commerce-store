...
namespace _19010230_e_commerce_store.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var prog7311Task2Context = _context.Products.Include(p => p.Category);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,CategoryId,ProductName,ProductDescription,ProductPrice,ProductImage")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,CategoryId,ProductName,ProductDescription,ProductPrice,ProductImage")] Product product)
        {
